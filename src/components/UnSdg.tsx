...
const BASE_URL = 'https://sdgs.un.org/sites/default/files/goals';
...
export const UnSdg: React.FC<UnSdgProps> = ({
  ...
  const imageUrl = useMemo(() => {
    if (typeof goal === 'number') {
      return `${BASE_URL}/SDG-${goal}.png`;
    }
    return `${BASE_URL}/SDG-${goal === 'all' ? 'TITLE' : 'CIRCLE'}.png`;
  }, [goal]);
    ...
    return (
      <div
        style={{
          width,
          height,
          backgroundColor: typeof goal === 'number' ? bgColor : '#e2e8f0',
          borderRadius: '4px',
          display: 'flex',
          alignItems: 'center',
